...
def main(inputFile, codebook, ouputDir):
    ...
    #print(df_byTract)
    create_output(df_byTract, df_codebook, ouputDir+"/"+outputFile+"_byTract")
...
# ACS_2019_5year__tract_Texas
# python ACS_selection_tract.py -i data/ACS_2020_5year__tract_Texas.csv -c data/ACS_2020_5year_codebook_all.xlsx -o data/output_Texas
