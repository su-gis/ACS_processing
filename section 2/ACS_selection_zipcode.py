...
def main(inputFile, codebook, ouputDir):
    ...
    for i in range(len(df_input)):
        geoid = "{:05d}".format(df_input.loc[i, 'zipcode'])  
        #geoid = "{:02d}{:05d}".format(df_input.loc[i, 'state'], df_input.loc[i, 'zipcode'])    
        #geoid = "{:02d}{:03d}{:06d}".format(df_input.loc[i, 'state'], df_input.loc[i, 'county'], df_input.loc[i, 'tract'])
        if (len(geoid) != 5):        
        #if (len(geoid) != 11): 
            print("Invalid length of tractid in {}    line-no: {} [{}]  {} bytes ".format(inputFile, i, geoid, len(geoid)))
        tractIDs.append(geoid)
    df_byTract = df_input.copy(deep=True)
    df_byTract.insert(loc=0, column='geoid', value=tractIDs)
    #print(df_byTract)
    create_output(df_byTract, df_codebook, ouputDir+"/"+outputFile+"_byZipcode")
...
# python ACS_selection_zipcode.py -i data/ACS_2021_5year__zipcode_US.csv -c data/ACS_2021_5year_codebook_all.xlsx -o data/output_zip_US/all

# python ACS_selection_zipcode.py -i data/ACS_2019_5year__zipcode_IL_SVI.csv -c data/ACS_2019_5year_codebook_all_for_SVI_prt.xlsx -o data/output_zip_IL/all
# python ACS_selection_zipcode.py -i data/ACS_2019_5year__zipcode_US_SVI.csv -c data/ACS_2019_5year_codebook_all_for_SVI_prt.xlsx -o data/output_zip_US/all

# python ACS_selection_zipcode.py -i data/ACS_2019_5year__zipcode_IL_SVI.csv -c data/ACS_2019_5year_codebook_all_for_SVI.xlsx -o data/output_zip_IL/all
# python ACS_selection_zipcode.py -i data/ACS_2019_5year__zipcode_US_SVI.csv -c data/ACS_2019_5year_codebook_all_for_SVI.xlsx -o data/output_zip_US/all

# python ACS_selection_zipcode.py -i data/ACS_2019_5year__zipcode_IL.csv -c data/ACS_2019_5year_codebook_all_for_VNE.xlsx -o data/output_zip_IL/all
# python ACS_selection_zipcode.py -i data/ACS_2019_5year__zipcode_US.csv -c data/ACS_2019_5year_codebook_all_for_VNE.xlsx -o data/output_zip_US/all
# python ACS_selection_zipcode.py -i data/ACS_2018_5year__zipcode_US.csv -c data/ACS_2018_5year_codebook_all_for_VNE.xlsx -o data/output_zip_US/all ############
# python ACS_selection_zipcode.py -i data/ACS_2018_5year__zipcode_US.csv -c data/ACS_2018_5year_codebook_all.xlsx -o data/output_zip_US/all 
# python ACS_selection_zipcode.py -i data/ACS_2018_5year__zipcode_US.csv -c data/ACS_2018_5year_codebook.xlsx -o data/output_zip_US/20  
# python ACS_selection_zipcode.py -i data/ACS_2018_5year__zipcode_IL.csv -c data/ACS_2018_5year_codebook_all.xlsx -o data/output_zip_IL/all 
# python ACS_selection_zipcode.py -i data/ACS_2018_5year__zipcode_IL.csv -c data/ACS_2018_5year_codebook.xlsx -o data/output_zip_IL/20    
